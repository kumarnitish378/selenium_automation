...
def Purchage_bill(k_email, k_password, mobile_number, a_id, a_pass):
    ...
    try:
        ...
        bill = search.find_element_by_xpath('/html/body/div[3]/div[2]/div[2]/div[2]/div/p[5]/a/img')
        bill.click()
    # 
        sleep(1)
        ...
        pay_bill = search.find_element_by_xpath('/html/body/div[2]/div/div/div[1]/div[3]/div[2]/div[2]/div[3]/section/form/div[13]/button')
        pay_bill.click()
        # 
