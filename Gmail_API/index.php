    ...
    <div class="container">
        <div class="row congratz">
            ...
            <div class="message">
                ...
                <p>
                    You can now login to your account using the email address and password you provided.
                </p>
                <p>
                    <a href="https://cpanel.hostinger.in" rel="nofollow">Login to your account</a>
                </p>
            </div>
        </div>
        ...
        <div class="footer">
            <div class="row">
                <div class="text-center" style="margin-bottom: 10px;">
                    <a href="https://cpanel.hostinger.in" rel="nofollow">Client Login Here</a>
                </div>
                <div class="copyright text-center">
                    Panini © <?php echo date("Y"); ?>. All rights reserved
                </div>
            </div>
        </div>
    </div>
